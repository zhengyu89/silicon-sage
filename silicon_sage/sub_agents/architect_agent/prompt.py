...
2. **Research:** Use `ResearchAgent` to find the 6 compatible parts parallely (CPU, GPU, Mobo, RAM, SSD, PSU) by querying for:
...
- **Physical Dimensions:** Ignore physical constraints like GPU length, RAM height, or Case size unless explicitly provided.
"""
